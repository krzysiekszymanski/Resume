      ...
      <section id="contact">
           <div className="row section-head">
              ...
              <div className="ten columns">
                    <p className="lead">Zachęcam do kontaktu telefonicznego, mailowego. Chciałbym znaleźć firmę w której będę mógł rozwinąć swoje umiejętności. Jestem otwarty na propozycje współpracy.
                    </p>
              </div>
           </div>
           <div className="row">
